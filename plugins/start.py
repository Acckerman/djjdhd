...
bot_username = os.environ.get("BOT_USERNAME","@Acckermanrename_bot")
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      ...
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://t.me/+syXjBDPQvdc2OTM1")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/k2m_movies_series'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/+9WSXzhex9E83MGM1')],
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact LazyDeveloper 🦋", url='https://t.me/k2m_movies_series')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://t.me/+syXjBDPQvdc2OTM1')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/k2m_movies_series'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://t.me/+9WSXzhex9E83MGM1')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://t.me/Acckerman_offical')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
        return 
